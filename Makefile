...
tcp-server: src/tcp-server.c uds.o
	$(CC) $(CFLAGS) src/tcp-server.c uds.o -o tcp-server
tcp-client: src/tcp-client.c uds.o
	$(CC) $(CFLAGS) src/tcp-client.c uds.o -o tcp-client
